...
import 'package:posq1_ticket/printerenum.dart';
...
class TestPrint {
  ...
  sample2() async {
    ...
    bluetooth.isConnected.then((isConnected) {
      if (isConnected == true) {
        bluetooth.printNewLine();
        // bluetooth.writeBytes(Uint8List.fromList("ຊື່ຮ້ານ:????  ສະຖານທີ່:????".codeUnits));
        // bluetooth.printCustom("ຊື່ຮ້ານ:????  ສະຖານທີ່:????", Size.boldMedium.val, Align.center.val, charset: 'utf-8');
        bluetooth.printNewLine();
        bluetooth.printImage(file.path); //path of your image/logo
        // bluetooth.printNewLine();
        // bluetooth.printImageBytes(imageBytesFromAsset); //image from Asset
        ...
        // bluetooth.printImageBytes(imageBytesFromNetwork); //image from Network
        // bluetooth.printNewLine();
        // bluetooth.printLeftRight("ເລກບິນ: 001", "", Size.medium.val, charset: 'utf-8');
        // bluetooth.printNewLine();
        // bluetooth.printLeftRight("ພະນັກງານ: ທ້າວ ຄຳ", "", Size.medium.val, charset: 'utf-8');
        // bluetooth.printNewLine();
        // bluetooth.printLeftRight("ເວລາ: 22/10/2022", "12:00", Size.medium.val, charset: 'utf-8');
        // bluetooth.printNewLine();
        // bluetooth.printLeftRight("ປະເພດລົດ: ລົດຈັກ", "", Size.medium.val, charset: 'utf-8');
        // bluetooth.printNewLine();
        // bluetooth.printLeftRight("ປ້າຍລົດ", "ເງິນ", Size.boldLarge.val, charset: 'utf-8');
        // bluetooth.printNewLine();
        // bluetooth.printLeftRight("----------", "----------", Size.boldLarge.val);
        // bluetooth.printNewLine();
        // bluetooth.printLeftRight("ຍທ 5555", "3,000", Size.medium.val, charset: 'utf-8');
        // bluetooth.printNewLine();
        // bluetooth.printLeftRight("----------", "----------", Size.boldLarge.val);
        // bluetooth.printNewLine();
        // bluetooth.printLeftRight("", "3,000", Size.extraLarge.val, charset: 'utf-8');
        bluetooth.printNewLine();
        bluetooth
            .paperCut(); //some printer not supported (sometime making image not centered)
        //bluetooth.drawerPin2(); // or you can use bluetooth.drawerPin5();
  ...
  sample3() async {
    ...
    bluetooth.isConnected.then((isConnected) {
      if (isConnected == true) {
        bluetooth.printNewLine();
        bluetooth.printCustom("Name:????  Address:????", Size.boldMedium.val, Align.center.val);
        bluetooth.printNewLine();
        bluetooth.printImage(file.path); //path of your image/logo
        // bluetooth.printNewLine();
        // bluetooth.printImageBytes(imageBytesFromAsset); //image from Asset
        ...
        // bluetooth.printImageBytes(imageBytesFromNetwork); //image from Network
        bluetooth.printNewLine();
        bluetooth.printLeftRight("Ticket ID: 001", "", Size.medium.val);
        bluetooth.printNewLine();
        bluetooth.printLeftRight("Personnel: Mr. Kham", "", Size.medium.val);
        bluetooth.printNewLine();
        bluetooth.printLeftRight("Date Time: 22/10/2022", "12:00", Size.medium.val);
        bluetooth.printNewLine();
        bluetooth.printLeftRight("Vehicle Cat: Small", "", Size.medium.val);
        bluetooth.printNewLine();
        bluetooth.printLeftRight("Plate Number", "Price", Size.boldLarge.val);
        bluetooth.printNewLine();
        bluetooth.printLeftRight("----------", "----------", Size.boldLarge.val);
        bluetooth.printNewLine();
        bluetooth.printLeftRight("NT 5555", "3,000", Size.medium.val);
        bluetooth.printNewLine();
        bluetooth.printLeftRight("----------", "----------", Size.boldLarge.val);
        bluetooth.printNewLine();
        bluetooth.printLeftRight("", "3,000", Size.extraLarge.val);
        bluetooth
            .paperCut(); //some printer not supported (sometime making image not centered)
        //bluetooth.drawerPin2(); // or you can use bluetooth.drawerPin5();
      }
